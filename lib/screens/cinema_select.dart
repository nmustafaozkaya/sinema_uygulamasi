...
class CinemaSelect extends StatefulWidget {
  const CinemaSelect({super.key});

  @override
  State<CinemaSelect> createState() => _CinemaScreenState();
}

class _CinemaScreenState extends State<CinemaSelect> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Cinema Selection', style: AppTextStyle.TOP_HEADER_),
      ),
      body: _isLoading
